...
public:
  ...
  virtual components get_components(double u, double v) const = 0;
};
...
public:
  ...
  Uniform_Texture(display::Colour c, double kd, double ks, double ns,
                  double reflexion)
      : c_{c}, kd_{kd}, ks_{ks}, ns_{ns}, reflexion_{reflexion} {}

  components get_components(double u, double v) const override;
...
public:
  ...
  Image_Texture(const display::Image &im, double kd, double ks, double ns,
                double reflexion)
      : im_{im}, kd_{kd}, ks_{ks}, ns_{ns}, reflexion_{reflexion} {}
